...
const parrafo2 = "Los girasoles u mirasoles familia de las asteráceas con sus pétalos amarillos y semillas cafés caracterizadas por moverse en dirección al sol para recibir su luz y cultivada por ser alimenticia, oleaginosa y ornamental en todo el mundo"
...
const parrafo4 = "Las margaritas son una planta herbácea de la familia de las asteráceas. Sus hojas son verdes y sus flores, muy conocidas: pétalos alargados y blancos, en torno a un botón circular amarillo. Muy utilizada para efectos decorativos mezclada con el césped, por sus colores y su resistencia a la siega"
const parrafo5 = "La palma de cera es una palma nativa de los bosques colombianos. Sus hojas son verdes, oscuras y grisáceas. El tronco es cilíndrico, liso, cubierto de cera y puede crecer hasta los 70M. Su cera se usa para fabricar velas, su tronco como buena madera y su fruto para el ganado"
